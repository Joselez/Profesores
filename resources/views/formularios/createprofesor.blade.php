...
<form id="formulario">
    ...
    <fieldset class="col-12">
        ...
        <div class="form-row">
         ...
         <div class="container">
      <label for="search_key" class="col-sm-3 col-form-label">Localidad</label>
        <div class="col-sm-6">
            <input type="text" class="form-control" id="show-user" name="show_user" value="" placeholder="Search by name or Email">
